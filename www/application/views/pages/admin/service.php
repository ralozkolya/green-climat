		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-sm-6">
					...
					<form action="<?php echo base_url('admin/add_images/Service_image'); ?>"
						method="post"
					...
					<?php foreach($gallery as $g): ?>
						<div class="thumb">
							<img alt="<?php echo $g->image; ?>" src="<?php echo static_url('uploads/services/thumbs/'.$g->image); ?>">
							<a href="<?php echo base_url('admin/delete/Service_image/'.$g->id); ?>" class="unstyled delete">
